        ...
        <div className="h-full flex flex-col bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
            <div className="relative">
                <img 
                    src={picture} 
                    alt={name} 
                    className="w-full h-52 md:h-56 lg:h-64 object-cover object-center"
                />
            ...
            <div className="p-5 md:p-6 flex-grow flex flex-col justify-between">
                <div>
                    <h3 className="text-xl md:text-2xl font-bold text-amber-800 mb-2">{name}</h3>
                    ...
                    <p className="text-gray-700 mb-4 md:mb-6 overflow-hidden line-clamp-3">{details}</p>
